...
Future Implementations (Time did not permit):

- Integrate with TailwindCSS for smoother UI experience
- Integrate with Google Gemini - I have integrated the free API experience with other applications and think that this could handle proactive climate requests well.
- Add verification for login (i.e. existing LinkedIn profile, 2 factor authentication with LinkedIn)
- Add publish and share functionality (copy link to profile to clipboard)
